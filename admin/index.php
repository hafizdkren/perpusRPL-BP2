...
$utama="<center><span class='s' >Selamat Datang di Sistem Informasi Perpustakaan SMK BP2. Untuk menggunakan, silakan memilih menu di samping kiri !. <br><br>Status Anda login sebagai <b>\" $sesi \"</b> Jangan lupa LOG OUT sebelum keluar</span></center>";
?>
<html>
<head>
...
<body>
<table border=0 width="100%" bgcolor="#195" cellpadding=2 cellspacing=2 >
	<tr>
		<td colspan="2"><img src="../image/image2.jpg" width="100%" height="214">
		 </td>
	</tr>
	<tr>
		<td colspan=2><marquee bgcolor="white" onMouseOver="this.stop();" behavior="alternate" onMouseOut="this.start();">Halaman Administrasi Perpustakaan SMK BINA PENDIDIKAN 2</marquee>		</td>
	</tr>
	<tr>
	...
	<div style="font-size: 12px; border: solid 1px orange; background: blue; color: orange"><p>Aplikasi Perpustakaan : </p></div>
	</div>	</td>
	...
	include "../anggota/$page.php";
	} else if($page=="cetak_lap_keseluruhan") {
	include "../anggota/$page.php";
	...
	<td colspan="2" style="border-top: solid 2px #f9f9f9; font-size: 12px" align="center">&copy; Copyright : Ananda Rauf Maududi  &nbsp; </a><br>All Right Reserved</td>
