...
if ($nama==""||$jk==""||$kelas==""||$cari=""||($perlu1=""&&$perlu2==""&&$perlu3==""&&$perlu4==)) {
 ...
 $query = mysqli_query( $konek,"INSERT INTO pengunjung VALUES (null, '$nama', '$jk', '$kelas', '$perlu1', '$perlu2', '$perlu3', '$perlu4', '$cari', '$saran', now(), '$jam')") or die (Gagal karena ".mysqli_error());
 if ($query) {
	 echo "<script>alert('Selamat datang : \" $nama \" di Perpustakaan SMK BINA PENDIDIKAN')</script>";
	 echo "<meta http-equiv='refresh' content='0; url=../index.php'>";
 } else
	 echo "<script>alert('Data anda gagal dimasukkan')</script>";
     echo "<meta hpp-equiv='refresh' content='0; url=../index.php;
 }
 }
 ?>
